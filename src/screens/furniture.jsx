...
import p1 from "../assets/images/furniture/halfRound.webp";
  ...
  const productList = [
    {
      ...
      price: "38.40",
      description:
        "Stainless Stee Half Round Door Stopper with Rubber Bumper Door Retainer",
    },
  ];
  return (
    <React.Fragment>
      ...
      >
        <TextOverlay>
          <h2>Our Products</h2>
          <h3 style={{ fontSize: "2rem" }}>Furniture Accessories</h3>
